...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/07/24 00:14:42 by avon-ben          #+#    #+#             */
/*   Updated: 2025/07/24 00:14:43 by avon-ben         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << "ClapTrap with name: " << this->_name << " was destroyed" << std::endl << std::endl;
}
